...
Функциональная схема одноразрядного четверичного сумматора представлена в ПРИЛОЖЕНИИ @app-ochs-scheme.
...
Функциональная схема преобразователя множителя представлена в ПРИЛОЖЕНИИ @app-pm-scheme.
