...
Преобразователь множителя (ПМ) это устройство, которое преобразовывает диады множителя в соответствии с алгоритмом «В» на 2 разряда. Принцип работы преобразователя описывается таблицей истинности (таблица //todo @tbl-pm).
